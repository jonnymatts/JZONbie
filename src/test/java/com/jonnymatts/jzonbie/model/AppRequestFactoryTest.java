...
import static com.jonnymatts.jzonbie.model.AppRequestTest.copyAppRequest;
...
public class AppRequestFactoryTest {
    ...
    public void createForRequest() throws Exception {
        ...
        when(deserializer.deserialize(expectedMap, AppRequest.class)).thenReturn(copyAppRequest(appRequest));
